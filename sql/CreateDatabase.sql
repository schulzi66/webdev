...
ALTER TABLE books
  DROP FOREIGN KEY IF EXISTS FK_books_member,
  DROP FOREIGN KEY IF EXISTS FK_books_images;
ALTER TABLE galleryimages
  DROP FOREIGN KEY IF EXISTS FK_gallery,
  DROP FOREIGN KEY IF EXISTS FK_images;
--
